          ...
          <div className="flex items-center gap-4">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="flex items-center gap-2 border-[#e57c73] text-white hover:bg-[#e57c73]/10">
              ...
              <PopoverContent className="w-48 bg-black border-[#e57c73]">
                <div className="flex flex-col gap-2">
                  <button 
                    ...
                    className="flex items-center gap-2 text-white px-4 py-2 hover:bg-[#e57c73]/10 rounded transition-colors"
                  >
